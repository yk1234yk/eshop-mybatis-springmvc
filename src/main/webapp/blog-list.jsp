                                ...
                                <div class="card-body px-0 pb-0">
                                    <div>
                                        <a class="d-inline-block link-title btn-link text-small"
                                           href="#">${blog.admin.username},</a>
                                        <a class="d-inline-block link-title btn-link text-small"
                                           href="#">${blog.admin.department}</a>
                                    </div>
                            ...
                            <ul class="pagination justify-content-center">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item">
                                            <a class="page-link"
                                               href="blog?method=list&pageSize=${page.pageSize}&pageIndex=${page.pageIndex-1}">前一页</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>


                                <c:forEach begin="1" end="${page.totalPage}" varStatus="staus">
                                    <li class="page-item">
                                        <a class="page-link"
                                           href="blog?method=list&pageSize=${page.pageSize}&pageIndex=${status.index}">${staus.index}</a>
                                    </li>
                                </c:forEach>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item">
                                            <a class="page-link"
                                               href="blog?method=list&pageSize=${page.pageSize}&pageIndex=${page.pageIndex}">后一页</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                            </ul>
